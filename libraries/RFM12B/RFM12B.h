...
class RFM12B
{
  ...
  void SPIInit();
    ...
    static uint8_t rssi_pin; // received signal power  
    static uint8_t rssi; // received signal power  
    ...
    void SendStart(uint8_t toNodeId, const void* sendBuf, uint8_t sendLen, bool requestACK=false, bool sendACK=false, uint8_t waitMode=3);
    void SendACK(const void* sendBuf = "", uint8_t sendLen=0, uint8_t waitMode=0);
    void Send(uint8_t toNodeId, const void* sendBuf, uint8_t sendLen, bool requestACK = false, uint8_t waitMode=2);
